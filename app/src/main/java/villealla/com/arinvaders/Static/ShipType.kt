...
enum class ShipType(val modelName: String, val speed: Int, val hp: Int, val dmgScaleValue: Float) {
    UFO("ufo_small_red.sfb", DEFAULT_MOVE_SPEED, DEFAULT_HP, 2.0f),
    THRALL("ufo_medium_yellow.sfb", DEFAULT_MOVE_SPEED, 2, 4.0f),
    MOTHERSHIP("ufo_large_green.sfb", DEFAULT_MOVE_SPEED, 3, 6.0f)
}